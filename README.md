...
Content-Type: application/json</code></pre>
  ...
  "date": "2024-02-13 13:09:34"
    ...
    <article>
        <h3>cURL</h3>
        <pre><code class="language-bash">curl --location 'http://localhost:8080/api/test-timezone/' \
...
<section>
    ...
    <article>
        <h3>cURL</h3>
        <pre><code class="language-bash">curl --location 'http://localhost:8080/api/test-timezone/?User-TimeZone=Asia%2FKabul'</code></pre>
    </article>
</section>
